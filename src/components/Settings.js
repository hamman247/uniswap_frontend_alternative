...
export class Settings {
    ...
    render() {
      ...
      <div class="settings-section">
        <div class="settings-section-title">Slippage Tolerance</div>
        ...
        <div class="slippage-custom">
          <input type="number" class="slippage-custom-input" id="slippage-custom"
                 placeholder="Custom %" step="0.1" min="0.01" max="50" />
          <span style="font-size: 0.8rem; color: var(--text-tertiary);">%</span>
        </div>
      </div>

      <div class="settings-section">
        <div class="settings-section-title">Transaction Deadline</div>
        <div class="deadline-input-container">
          ...
          <span class="deadline-label">minutes</span>
        </div>
      </div>
      ...
      <div class="settings-section">
        ...
        <div class="settings-toggle-row">
          <label class="settings-toggle-label" for="testnet-toggle">Show Testnets</label>
